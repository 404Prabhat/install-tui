...
- Responsive, undistorted renderer:
  - wide tri-pane
  - medium split
  - narrow stacked
  - minimal fallback for tiny terminals
...
- Development timeline and all major pivots:
  - `development.md`
- Maintainer/contributor prompt and workflow guide:
  - `prompt.md`
